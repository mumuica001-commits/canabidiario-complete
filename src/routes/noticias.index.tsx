...
export const Route = createFileRoute("/noticias/")({
  head: () => ({
    meta: [
      { title: "Notícias e Ciência — Canabidiário" },
      {
        name: "description",
        content:
          "Artigos sobre cannabis medicinal assinados por especialistas: insônia, ansiedade, odontologia canabinoide, cultivo, regulamentação e mais.",
      },
    ],
  }),
