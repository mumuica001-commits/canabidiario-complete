...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Canabidiário | Medicina com Cannabis" },
      {
        name: "description",
        content:
    ...
    <main className="overflow-hidden bg-paper">
        ...
        <div className="wrap grid items-center gap-12 lg:grid-cols-12">
          ...
          <div className="space-y-6 lg:col-span-7">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <Link
                to="/patologias"
                className="inline-flex items-center justify-center rounded-md border border-border bg-card px-5 py-3 text-xs font-mono font-semibold uppercase tracking-wider text-pine shadow-xs hover:border-pine hover:bg-card-soft transition-all"
              >
      ...
      <section className="border-b border-border bg-paper-deep py-20">
        <div className="wrap space-y-12">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Reveal delay={0}>
              <div className="flex h-full flex-col justify-between rounded-2xl border border-border bg-card p-8 space-y-4 shadow-xs">
            ...
            <Reveal delay={80}>
              <div className="flex h-full flex-col justify-between rounded-2xl border border-border bg-card p-8 space-y-4 shadow-xs">
                ...
                <p className="text-sm text-ink-soft leading-relaxed">
                  Com o diagnóstico em mãos, o profissional prescreve a formulação, proporção e dosagem exata para você.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={160}>
              <div className="flex h-full flex-col justify-between rounded-2xl border border-border bg-card p-8 space-y-4 shadow-xs">
                ...
                <p className="text-sm text-ink-soft leading-relaxed">
                  Adquira o produto prescrito com apoio sanitário e acompanhe sua evolução nas consultas periódicas.
                </p>
              </div>
            </Reveal>
          </div>
      ...
      <section className="py-20 bg-paper border-b border-border">
        <div className="wrap space-y-12">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
            ...
            >
              <span>Ver todas as condições</span>
      ...
      <section className="bg-pine py-16 md:py-24 text-paper text-center">
        <div className="wrap max-w-3xl space-y-6">
          ...
          <h2 className="font-serif text-3xl sm:text-5xl font-medium leading-tight text-paper">
